...
router.post('/balanceOf',async function(req,res,next){
    let opt = {
        host: '121.40.249.148',    //目标区块链网络节点的 IP
        port: 18130,          //端口号
        timeout: 30000,       //连接超时时间配置
...
router.post('/getBaseURL',async function(req,res,next){
    let opt = {
        host: '121.40.249.148',    //目标区块链网络节点的 IP
        port: 18130,          //端口号
        timeout: 30000,       //连接超时时间配置
...
router.post('/getTokenURL',async function(req,res,next){
    let opt = {
        host: '121.40.249.148',    //目标区块链网络节点的 IP
        port: 18130,          //端口号
        timeout: 30000,       //连接超时时间配置
...
router.post('/ownerOf',async function(req,res,next){
    let opt = {
        host: '121.40.249.148',    //目标区块链网络节点的 IP
        port: 18130,          //端口号
        timeout: 30000,       //连接超时时间配置
...
router.post('/setBaseURL',async function(req,res,next){
    let opt = {
        host: '121.40.249.148',    //目标区块链网络节点的 IP
        port: 18130,          //端口号
        timeout: 30000,       //连接超时时间配置
...
router.post('/newContract', async function(req, res, next) {
